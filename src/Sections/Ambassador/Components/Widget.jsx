...
const BoardingHouseWidget = () => {
  const [boardingHouses, setBoardingHouses] = useState([
    { id: 1, name: "Sunrise Hostel", location: "Cavendish - Main", verified: false },
  ...
  return (
    <div className="border border-gray-100 w-full mx-auto bg-white shadow-md rounded-lg p-6 my-2">
      <h2 className="text-2xl font-semibold mb-4 text-gray-700">Submitted Boarding Houses💃</h2>

      {/* Counters */}
      <div className="flex items-center justify-between mb-4">
        <div className="text-center">
          <p className="text-2xl text-red-500 font-bold">{boardingHouses.length}</p>
